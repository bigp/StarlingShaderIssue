...
import tv.telequebec.net.queueLoader.UrlLoaderAndLoaderQueue;
import tv.telequebec.net.queueLoader.UrlLoaderAndRequestVO;
    ...
    public class AssetManager extends EventDispatcher
    {
        ...
        protected function loadRawAsset(rawAsset:Object, onProgress:Function, onComplete:Function):void
        {
            ...
            else if (rawAsset is String || rawAsset is URLRequest)
            {
	            ...
	            UrlLoaderAndLoaderQueue.addUrlLoaderToQueue(new UrlLoaderAndRequestVO(urlLoader, new URLRequest(url)));
            ...
            {
                if (onProgress != null && event.bytesTotal > 0 && event.bytesLoaded <= event.bytesTotal)
