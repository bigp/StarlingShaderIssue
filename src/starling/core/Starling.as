...
package starling.core
{
    ...
    public class Starling extends EventDispatcher
    {
        ...
        private var _mStatsDisplay:StatsDisplay;
        ...
        public function render():void
        {
            ...
            if (_mStatsDisplay)
                _mStatsDisplay.drawCount = mSupport.drawCount;
         ...
         *  memory analysis.</p>
         */
        public function get showStats():Boolean { return _mStatsDisplay && _mStatsDisplay.parent; }
        public function set showStats(value:Boolean):void
        {
            ...
            if (value)
            {
                if (_mStatsDisplay) mStage.addChild(_mStatsDisplay);
                else               showStatsAt();
            }
            else _mStatsDisplay.removeFromParent();
        }
        ...
        public function showStatsAt(hAlign:String="left", vAlign:String="top", scale:Number=1):void
        {
            ...
            {
                if (_mStatsDisplay == null)
                {
                    _mStatsDisplay = new StatsDisplay();
                    _mStatsDisplay.touchable = false;
                    mStage.addChild(_mStatsDisplay);
                }
                
                var stageWidth:int  = mStage.stageWidth;
                var stageHeight:int = mStage.stageHeight;
                
                _mStatsDisplay.scaleX = _mStatsDisplay.scaleY = scale;
                
                if (hAlign == HAlign.LEFT) _mStatsDisplay.x = 0;
                else if (hAlign == HAlign.RIGHT) _mStatsDisplay.x = stageWidth - _mStatsDisplay.width;
                else _mStatsDisplay.x = int((stageWidth - _mStatsDisplay.width) / 2);
                
                if (vAlign == VAlign.TOP) _mStatsDisplay.y = 0;
                else if (vAlign == VAlign.BOTTOM) _mStatsDisplay.y = stageHeight - _mStatsDisplay.height;
                else _mStatsDisplay.y = int((stageHeight - _mStatsDisplay.height) / 2);
            }
        ...
        public function get mStatsDisplay():StatsDisplay {
            return _mStatsDisplay;
        }
    }
}
